...
function sendApiRequest(searchfor) {
  
    fetch("https://api.giphy.com/v1/gifs/search?api_key=UPUmZXLNelLltzgXmFQu92qVgX2obzov&q="+searchfor+"&limit=25&offset=0&rating=G&lang=en")
    .then(function(data) {
      return data.json();
    })
    .then(function(json) {
